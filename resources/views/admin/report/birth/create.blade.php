...
<ol class="breadcrumb m-0">
    <li class="breadcrumb-item active">
        <a href="{{ route('admin::report::birth::index') }}">Birth Management</a>
    </li>
    <li class="breadcrumb-item active">Add new birth</li>
</ol>
@endsection
        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <h5 class="mb-10">Add New Birth</h5>
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <button class="btn btn-primary" type="submit">Save birth</button>
                            </div>
                        </div>
                    </form>
                </section>
