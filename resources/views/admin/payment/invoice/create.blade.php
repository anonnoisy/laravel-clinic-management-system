        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <h5 class="mb-10">Add New Invoice</h5>
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <input type="text" class="form-control form-control-sm mt-15 datepicker-here" name="due_date" value="{{ old('creation_date') }}" placeholder="Enter due date" data-language="en" />
                            </div>
                            <div class="col-sm-12 form-group">
