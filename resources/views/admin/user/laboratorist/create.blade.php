...
<ol class="breadcrumb m-0">
    ...
    <li class="breadcrumb-item active">Add new laboratorist</li>
</ol>
@endsection
        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <h5 class="mb-10">Add New Laboratorist</h5>
                    <form action="{{ route('admin::user::laboratorist::store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
