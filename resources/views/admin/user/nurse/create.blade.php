...
<ol class="breadcrumb m-0">
    ...
    <li class="breadcrumb-item active">Add new nurse</li>
</ol>
@endsection
        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    ...
                    <h5 class="mb-10">Add New Nurse</h5>
                    <form action="{{ route('admin::user::nurse::store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
