...
<ol class="breadcrumb m-0">
    <li class="breadcrumb-item active">
        <a href="{{ route('admin::user::pharmacist::index') }}">Pharmacist Management</a>
    </li>
    <li class="breadcrumb-item active">Add new pharmacist</li>
</ol>
@endsection
        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <h5 class="mb-10">Add New Pharmacist</h5>
                    <form action="{{ route('admin::user::pharmacist::store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
