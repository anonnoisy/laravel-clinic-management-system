        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    ...
                    <h5 class="mb-10">Add New Medicine</h5>
                    <form action="{{ route('admin::medicine::store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12 col-md-6 form-group">
                                <label for="name">Medicine name</label>
                                <input class="form-control form-control-sm mt-15 @error('name') is-invalid @enderror" id="name" type="text" name="name" value="{{ old('name') }}" placeholder="Enter medicine name">
                                @error('name')
                            ...
                            <div class="col-sm-12 col-md-6 form-group">
                                ...
                                <input class="form-control form-control-sm mt-15 @error('price') is-invalid @enderror" id="price" type="price" name="price" value="{{ old('price') }}" placeholder="Enter price">
                                @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <input type="text" id="manufacture_company" placeholder="Enter manufacturing company" name="manufacture_company" value="{{ old('manufacture_company') }}" class="form-control form-control-sm mt-15 @error('manufacture_company') is-invalid @enderror"/>
                            ...
                            <div class="col-sm-12 col-md-12 form-group">
                                ...
                                <textarea id="description" placeholder="Enter description" name="description" class="form-control form-control-sm mt-15 @error('description') is-invalid @enderror" rows="3">{{ old('description') }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
