            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        ...
                        <li><a href="{{ route('admin::bed::allotment::index') }}">Bed Allotment</a></li>
                        <li><a href="{{ route('admin::blood::bank::index') }}">Blood Bank</a></li>
                        <li><a href="{{ route('admin::blood::donor::index') }}">Blood Donor</a></li>
                        <li><a href="{{ route('admin::medicine::index') }}">Medicine</a></li>
                        <li><a href="{{ route('admin::medicine::sale::index') }}">Medicine Sale</a></li>
                        <li><a href="{{ route('admin::report::operation::index') }}">Operation Report</a></li>
                        <li><a href="{{ route('admin::report::birth::index') }}">Birth Report</a></li>
                        <li><a href="{{ route('admin::report::death::index') }}">Death Report</a></li>
                    </ul>
                </li>
                <li>
                    <a href="{{ route('admin::department::index') }}" class="waves-effect">
